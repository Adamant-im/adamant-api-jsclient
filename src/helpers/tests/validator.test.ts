...
describe('isAdmPublicKey', () => {
  ...
  test('should return false for a string that contains `L`', () => {
    expect(
      validator.isAdmPublicKey('Le003f782cd1c1c84a6767a871321af2ecdb3da8d8f6b8d1f13179835b6ec432')
    ).toBe(false)
  })

  test('should return true for a public key that starts with a number', () => {
    expect(
      validator.isAdmPublicKey('4e003f782cd1c1c84A6767a871321af2ecdb3da8d8f6b8d1f13179835b6ec432')
    ).toBe(true)
  })

  test('should return true for a public key that starts with a letter', () => {
    expect(
      validator.isAdmPublicKey('e4003f782cd1c1c84A6767a871321af2ecdb3da8d8f6b8d1f13179835b6ec432')
    ).toBe(true)
  })
})
...
describe('validateMessage', () => {
  ...
  test('should return true for an empty string signal message', () => {
    expect(validator.validateMessage('', MessageType.Signal).success).toBe(true)
  })

  test('should return true for an empty json rich message', () => {
    expect(validator.validateMessage('{}', MessageType.Rich).success).toBe(true)
  })
  ...
  test('should return true for a json rich message with the given amount', () => {
    expect(validator.validateMessage('{"amount": "0.13"}', MessageType.Rich).success).toBe(true)
  })

  test('should return true for a json signal message with the given amount', () => {
    expect(validator.validateMessage('{"amount": "0.13"}', MessageType.Signal).success).toBe(true)
  })

  test('should return false for a json rich message with uppercase coin name', () => {
    expect(
      validator.validateMessage('{"amount": "0.13", "type": "ETH_transaction"}', MessageType.Rich)
        .success
    ).toBe(false)
  })
  ...
  test('should return true for a json signal message with uppercase coin name', () => {
    expect(
      validator.validateMessage('{"amount": "0.13", "type": "ETH_transaction"}', MessageType.Signal)
        .success
    ).toBe(true)
  })
  ...
  test('should allow a string signal message', () => {
    expect(validator.validateMessage('not a json string', MessageType.Signal).success).toBe(true)
  })

  test('should NOT allow a string rich message', () => {
    expect(validator.validateMessage('not a json string', MessageType.Rich).success).toBe(false)
  })
})
