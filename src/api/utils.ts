...
export const isVoteDirection = (direction: unknown): direction is VoteDirection =>
  typeof direction === 'string' && VOTE_DIRECTIONS.includes(direction as VoteDirection)
...
export const transformTransactionQuery = <T extends object>(obj?: TransactionQuery<T>) => {
  if (!obj) {
    return {}
  }
